...
convert_header(IMAGES + 'Bid/Delay.png',                                                       BASE + 'Images.hpp', 'Delay', 4, 38, 24)
...
convert_header(IMAGES + 'Titles/TitleEuchre_Assist.png',                                       BASE + 'Images.hpp', 'TitleEuchre_Assist', 4, 128, 64)
convert_header(IMAGES + 'Titles/TitleEuchre_Assist_Cursor.png',                                BASE + 'Images.hpp', 'TitleEuchre_Assist_Cursor', 4, 9, 16)
